...
Install `Ruby 2.5.1` using your Ruby version manager of choice ([ruby-install](https://github.com/postmodern/ruby-install)/[chruby](https://github.com/postmodern/chruby), [rbenv](https://github.com/rbenv/rbenv), [brew](https://brew.sh), etc)
...
* [@Geoff Foley](https://github.com/geofffoley)
* ( add yourself )
