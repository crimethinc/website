class AboutController < ApplicationController
  ...
  def read
    ...
    @featured_classics              = Article.find_by(slug: "there-is-a-difference-between-life-and-survival")
    @featured_classics              = Article.first # TODO TEMP placeholder until TEXTs get migrated
  end
