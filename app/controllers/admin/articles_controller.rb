module Admin
  class ArticlesController < Admin::AdminController
    ...
    def create
      ...
      if @article.save
        redirect_to [:admin, @article], notice: t('admin.articles.created')
      else
        render :new
      end
    end
    ...
    def update
      ...
      if @article.update article_params
        ...
        redirect_to [:admin, @article], notice: t('admin.articles.updated')
      else
        render :edit
      end
    end
    ...
    def destroy
      ...
      @article.destroy
      redirect_to %i[admin articles], notice: t('admin.articles.destroyed')
    end
