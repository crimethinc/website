...
RSpec.describe AboutController, type: :controller do
  describe 'GET #library' do
    let!(:featured_current_events) { create(:article, slug: 'feature-report-back-from-the-battle-for-sacred-ground', publication_status: 'published', published_at: Date.current) }
    let!(:featured_theory_and_critique) { create(:article, slug: 'feature-from-democracy-to-freedom', publication_status: 'published', published_at: Date.current) }
    let!(:featured_classics) { create(:article, slug: 'why-we-dont-make-demands', publication_status: 'published', published_at: Date.current) }
    let!(:featured_strategy_and_analysis) do
      create(:article,
             slug: 'feature-understanding-the-kurdish-resistance-historical-overview-eyewitness-report',
